...
function main() {
   $(document).ready(function(){
      ...
      $("#Load").click(function(){
         ...
         var lineBreak,line,input,temp_line,fieldBreak;
         ...
         //   temp_line=[];
         //   while(line.length > 0){
         //      fieldBreak = line.indexOf(',');
         //      console.log(line.slice(0,fieldBreak));
         //      temp_line.push(line.slice(0,fieldBreak));
         //      line = line.slice(fieldBreak+1);
         //   }
         //   records_raw.push(clean(temp_line));
         //}
